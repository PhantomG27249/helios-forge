    ...
    sections: {
      ...
      icr: {
        ...
        fields: [
          ...
          { path: ['icr', 'useModelRunners'], label: 'Use model runners (requires ICR lane gate)', type: 'checkbox' },
          ...
          { path: ['icr', 'hypothesisCount'], label: 'Hypothesis count', type: 'number', min: 1, max: 32 },
          { path: ['icr', 'hypothesisRefreshInterval'], label: 'Hypothesis refresh interval', type: 'number', min: 1, max: 32 },
          { path: ['icr', 'pqfInterval'], label: 'PQF interval', type: 'number', min: 1, max: 32 },
          { path: ['icr', 'distillationInterval'], label: 'Distillation interval', type: 'number', min: 1, max: 32 },
